...
check_contains "bug-template-evidence-collector" ".github/ISSUE_TEMPLATE/bug-report.yml" "scripts/collect-agent-cooling-evidence.sh" "Bug report template points helper and agent reports to the read-only evidence collector."
check_contains "bug-template-helper-hotfix" ".github/ISSUE_TEMPLATE/bug-report.yml" "v1.1.1 source-first hotfix" "Bug report template routes known v1.1.0 helper-unreachable reports to the source-first hotfix."
check_contains "bug-template-no-retag" ".github/ISSUE_TEMPLATE/bug-report.yml" "Do not retag v1.1.0 or replace its unsigned-dev assets" "Bug report template preserves the immutable source-first release boundary."

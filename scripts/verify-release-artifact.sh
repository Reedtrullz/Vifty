...
write_summary() {
  ...
  write_check 0 "schema-resources" "passed" "release-trust" "App bundle contained valid release and viftyctl JSON Schemas with expected IDs in Contents/Resources/schemas."

...
- **Codex usage tracking** — optional menu-bar mode reads local Codex `token_count` events from `~/.codex/sessions` to show 5-hour usage percentage and reset countdown without network calls or API keys.

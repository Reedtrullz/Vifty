...
- A release readiness preflight script now validates local release metadata, required secret names, and GitHub Release asset presence with human and schema-backed JSON output so maintainers can distinguish source/tag readiness from a trust-complete public binary release.

...
- GitHub workflows now opt JavaScript actions into Node.js 24, and release metadata validation rejects CI or Release workflow drift back to the deprecated Node.js 20 runtime.

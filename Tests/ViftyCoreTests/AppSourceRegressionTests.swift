...
final class AppSourceRegressionTests: XCTestCase {
    ...
    func testCurveEditorShowsDraggableChartForActualFanCurves() throws {
        ...
        XCTAssertTrue(contentView.contains("private var baseCurveSeries: FanCurveChartSeries"))
        XCTAssertTrue(contentView.contains("FanCurveChartSeries(name: \"Base\", label: \"Base\""))
        XCTAssertTrue(contentView.contains("private var baseCurveValueLabelSeries: FanCurveChartSeries"))
        XCTAssertTrue(contentView.contains("let offset = fanCurveSeries.isEmpty ? -1 : fanCurveSeries.count"))
        ...
        XCTAssertTrue(contentView.contains("private var valueText: String"))

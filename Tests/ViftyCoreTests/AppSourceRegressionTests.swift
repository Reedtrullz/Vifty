...
final class AppSourceRegressionTests: XCTestCase {
    ...
    func testMenuBarPowerRowsAndStatusItemDisplayModeAreWired() throws {
        ...
        XCTAssertTrue(statusItemController.contains("allowsPlaceholderText: Bool"))
        XCTAssertTrue(statusItemController.contains("guard allowsPlaceholderText || !statusItemText.contains(\"--\") else { return nil }"))

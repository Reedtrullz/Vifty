...
final class AppSourceRegressionTests: XCTestCase {
    ...
    func testAgentWorkflowRuleCanBeCopiedFromMainWindowOnly() throws {
        let contentView = try read("Sources/Vifty/ContentView.swift")
        ...
        XCTAssertTrue(contentView.contains("copyAgentWorkflowCommand: copyAgentWorkflowCommand(_:mode:)"))
        XCTAssertTrue(contentView.contains("copyAgentWorkflowRule: copyAgentWorkflowRule"))
        XCTAssertTrue(contentView.contains("menuBarCustomFieldBinding: menuBarCustomFieldBinding(_:)"))
    ...
    func testMainWindowPanesAreIndependentlyScrollableAndFillAvailableHeight() throws {
        ...
        XCTAssertTrue(contentView.contains("workbenchControlRailSectionsView("))
    ...
    func testMenuBarPowerRowsAndStatusItemDisplayModeAreWired() throws {
        ...
        XCTAssertTrue(settingsTools.contains("Picker(\"Curve profile\", selection: $selectedProfileID)"))
        ...
        XCTAssertTrue(appModel.contains("private let idleBackgroundPollInterval: Duration = .seconds(10)"))
        XCTAssertTrue(appModel.contains("private let activeBackgroundPollInterval: Duration = .seconds(5)"))

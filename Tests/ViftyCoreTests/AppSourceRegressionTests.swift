...
final class AppSourceRegressionTests: XCTestCase {
    ...
    func testMenuBarPowerRowsAndStatusItemDisplayModeAreWired() throws {
        ...
        XCTAssertTrue(viftyApp.contains("refreshMenuBarStatusItemTelemetry()"))
        XCTAssertTrue(viftyApp.contains("private func refreshMenuBarStatusItemTelemetry()"))
        XCTAssertTrue(viftyApp.contains(".id(model.menuBarStatusItemRevision)"))
        XCTAssertTrue(viftyApp.contains("model.start()\n        Task { @MainActor in\n            await model.primeMenuBarStatusItemTelemetry()\n        }"))
        ...
        XCTAssertTrue(appModel.contains("func primeMenuBarStatusItemTelemetry() async"))

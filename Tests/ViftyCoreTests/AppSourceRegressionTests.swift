...
final class AppSourceRegressionTests: XCTestCase {
    ...
    func testMenuBarPowerRowsAndStatusItemDisplayModeAreWired() throws {
        ...
        XCTAssertTrue(contentView.contains("private var quickSettingsStrip: some View"))
        XCTAssertTrue(contentView.contains("ViewThatFits(in: .horizontal)"))
        XCTAssertTrue(contentView.contains("HStack(spacing: 14)"))
        XCTAssertTrue(contentView.contains("VStack(alignment: .leading, spacing: 8) {\n                    curveProfileSettings\n                    startupModeSettings\n                    launchAtLoginSettings\n                }"))
        XCTAssertTrue(contentView.contains("private var startupModeSettings: some View"))
        XCTAssertTrue(contentView.contains("private var curveProfileSettings: some View"))
        XCTAssertTrue(contentView.contains("quickSettingsStrip"))
        XCTAssertTrue(contentView.contains("Picker(\"Default mode\", selection: $model.startupMode)"))
        XCTAssertTrue(contentView.contains("Picker(\"Curve profile\", selection: $selectedProfileID)"))
        ...
        XCTAssertTrue(contentView.contains("private var codexUsageDisplayControls: some View {\n        VStack(alignment: .leading, spacing: 6)"))
        XCTAssertFalse(contentView.contains("private var codexUsageDisplayControls: some View {\n        HStack(spacing: 8)"))
    ...
    func testAppWindowCurveProfileSelectorUsesSavedProfiles() throws {
        ...
        XCTAssertTrue(contentView.contains("Picker(\"Curve profile\", selection: $selectedProfileID)"))
        XCTAssertTrue(contentView.contains("ForEach(model.savedProfiles)"))
        XCTAssertTrue(contentView.contains("_ = model.selectCurveProfile(id: newID)"))
    ...
    func testCurveEditorShowsDraggableChartForActualFanCurves() throws {
        ...
        XCTAssertTrue(contentView.contains("private let chartHeight: CGFloat = 272"))
        XCTAssertTrue(contentView.contains(".frame(height: chartHeight)"))
        XCTAssertFalse(contentView.contains(".frame(height: 184)"))
        XCTAssertTrue(contentView.contains("private var liveCurveTargetText: String?"))
        XCTAssertTrue(contentView.contains("Text(liveCurveTargetText)"))
        XCTAssertTrue(contentView.contains("let targetRPM = targetRPM(at: liveTemperature, points: basePoints)"))
        XCTAssertTrue(contentView.contains("return \"Live \\(Int(liveTemperature.rounded())) C -> Base \\(formattedRPM(targetRPM))\""))
        XCTAssertTrue(contentView.contains("private func targetRPM(at temperature: Double, points: [FanCurveChartPoint]) -> Int"))
        ...
        XCTAssertTrue(contentView.contains("@State private var activeChartPoint: CurveChartPointKind?"))
        XCTAssertTrue(contentView.contains("if let activePoint = activeBasePoint"))
        XCTAssertTrue(contentView.contains("curvePointAxisGuides(for: [activePoint], color: .accentColor, in: geometry.size)"))
        XCTAssertTrue(contentView.contains("curvePointAxisValueLabels(for: [activePoint], color: .accentColor, in: geometry.size)"))
        ...
        XCTAssertTrue(contentView.contains("showsValueLabel: activeChartPoint == point"))
        XCTAssertTrue(contentView.contains("valueLabelOffsetY: activeHandleLabelOffsetY(for: value)"))
        XCTAssertTrue(contentView.contains("onHoverChanged: { isHovering in"))
        XCTAssertTrue(contentView.contains("activeChartPoint = isHovering ? point : nil"))
        XCTAssertTrue(contentView.contains("activeChartPoint = point\n                                        setCurvePoint(point, from: value.location, in: geometry.size)"))
        XCTAssertTrue(contentView.contains(".onEnded { _ in activeChartPoint = nil }"))
        ...
        XCTAssertTrue(contentView.contains("private func activeHandleLabelOffsetY(for point: FanCurveChartPoint) -> CGFloat"))
        ...
        XCTAssertTrue(contentView.contains("value.chartValueText"))
        ...
        XCTAssertTrue(contentView.contains("private var curvePointSummaryStrip: some View"))
        XCTAssertTrue(contentView.contains("ForEach(basePoints) { point in"))
        XCTAssertTrue(contentView.contains("CurveChartPointSummaryChip(point: point)"))
        XCTAssertTrue(contentView.contains("private struct CurveChartPointSummaryChip: View"))
        XCTAssertTrue(contentView.contains("if !fanCurveSeries.isEmpty"))
        XCTAssertTrue(contentView.contains("chartLegendSwatch(.accentColor, label: \"Base\")"))
        ...
        XCTAssertTrue(contentView.contains(".accessibilityValue(point.accessibilityValueText)"))
    ...
    func testMainWindowNotificationSettingsAreWired() throws {
        ...
        XCTAssertTrue(contentView.contains("private var notificationSettings: some View"))
        XCTAssertTrue(contentView.contains("Label(\"Notifications\", systemImage: \"bell\")"))
        XCTAssertTrue(contentView.contains("Toggle(\"Helper failure\", isOn: $model.notificationSettings.helperFailure)"))
        XCTAssertTrue(contentView.contains("Toggle(\"High thermal pressure\", isOn: $model.notificationSettings.elevatedThermalPressure)"))
        XCTAssertTrue(contentView.contains("Toggle(\"Auto restore failure\", isOn: $model.notificationSettings.autoRestoreFailure)"))
        XCTAssertTrue(contentView.contains("Toggle(\"Plugged-in battery drain\", isOn: $model.notificationSettings.pluggedInBatteryDrain)"))
        XCTAssertTrue(contentView.contains("Toggle(\"Agent cooling attention\", isOn: $model.notificationSettings.agentCoolingAttention)"))
        XCTAssertFalse(menuBarView.contains("Label(\"Notifications\", systemImage: \"bell\")"))

...
final class AppSourceRegressionTests: XCTestCase {
    ...
    func testCurveEditorShowsDraggableChartForActualFanCurves() throws {
        ...
        XCTAssertTrue(contentView.contains("Text(\"\\(seriesLabel) \\(point.label): \\(Int(point.temperature.rounded())) C · \\(Int(point.rpm.rounded()).formatted(.number.grouping(.automatic))) RPM\")"))

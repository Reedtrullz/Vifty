...
final class AppSourceRegressionTests: XCTestCase {
    ...
    func testCurveEditorShowsDraggableChartForActualFanCurves() throws {
        ...
        XCTAssertTrue(contentView.contains("temperatureText: value.temperatureText"))
        XCTAssertTrue(contentView.contains("rpmText: value.rpmText"))
        XCTAssertTrue(contentView.contains("accessibilityValueText: value.accessibilityValueText"))
        XCTAssertTrue(contentView.contains("valueLabelOffset: valueLabelOffset(for: value, in: geometry.size)"))
        XCTAssertTrue(contentView.contains("private func valueLabelOffset(for point: FanCurveChartPoint, in size: CGSize) -> CGSize"))
        XCTAssertTrue(contentView.contains("private struct ChartHandleValueLabel: View"))
        XCTAssertTrue(contentView.contains("ChartHandleValueLabel(label: label, temperatureText: temperatureText, rpmText: rpmText)"))
        XCTAssertTrue(contentView.contains("Text(label)"))
        XCTAssertTrue(contentView.contains("Text(temperatureText)"))
        XCTAssertTrue(contentView.contains("Text(rpmText)"))
        ...
        XCTAssertTrue(contentView.contains("point.temperatureText"))
        XCTAssertTrue(contentView.contains("point.rpmText"))

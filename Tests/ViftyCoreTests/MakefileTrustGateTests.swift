...
final class MakefileTrustGateTests: XCTestCase {
    ...
    func testVerifyTargetRunsLocalTrustGates() throws {
        ...
        XCTAssertTrue(makefile.contains("verify: check-toolchain ## Run fast local trust gates without installing"))
        ...
        XCTAssertTrue(makefile.contains("test-fast: check-toolchain ## Run the fast local XCTest suite"))
        XCTAssertTrue(makefile.contains("test-full: check-toolchain ## Run the full XCTest suite, including slow evidence/release script tests"))
    ...
    func testVerifyTargetIsListedAsPhonyAndHelpVisible() throws {
        ...
        XCTAssertTrue(makefile.contains("run-app: check-toolchain ## Build and open the local app bundle"))
        ...
        XCTAssertTrue(makefile.contains("install-dev-adhoc: check-toolchain ## Explicit debug-only install with exact UID/path XPC allowlist"))

...
final class ValidationEvidenceScriptTests: XCTestCase {
    func testCollectorCapturesReadOnlyViftyCtlEvidence() throws {
        ...
        XCTAssertTrue(capabilitiesContract.contains("wrapperResources.workloadScripts\tcargo-build.sh,cargo-test.sh,custom-workload.sh"))

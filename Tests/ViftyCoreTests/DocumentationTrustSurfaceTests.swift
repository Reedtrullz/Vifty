...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testSupportTriageGuideCoversEvidenceBuckets() throws {
        ...
        XCTAssertTrue(releaseTrustTemplate.contains("scripts/check-release-readiness.sh --version 1.1.0 --repo Reedtrullz/Vifty --require-source-ref origin/main --json"))
        ...
        XCTAssertTrue(triage.contains("scripts/check-release-readiness.sh --version <version> --repo Reedtrullz/Vifty --require-source-ref origin/main --json"))
        XCTAssertTrue(triage.contains("Do not treat a source tag, CI artifact, or local ad-hoc build as a trusted public binary release."))

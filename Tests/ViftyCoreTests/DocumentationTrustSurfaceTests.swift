...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(integrations.contains("avoid the uncooled fallback when Vifty recommends backing off or restoring Auto first"))
        ...
        XCTAssertTrue(exampleReadme.contains("will not use this fallback when Vifty recommends `backOffWorkload` or `restoreAutoBeforeRetry`"))
    ...
    func testStrategyWorkplanReflectsCurrentSourceFirstState() throws {
        ...
        XCTAssertTrue(workplan.contains("refuses uncooled execution for `backOffWorkload` and `restoreAutoBeforeRetry`"))

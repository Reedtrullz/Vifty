...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testDocsKeepTelemetryHistoryVisualizationLocalAndScoped() throws {
        ...
        XCTAssertTrue(readme.contains("Codex usage mode is optional. When selected, Vifty asks the local Codex CLI/app-server for account rate-limit data"))
        ...
        XCTAssertTrue(trustModel.contains("The optional **Codex usage** menu-bar mode is separate"))

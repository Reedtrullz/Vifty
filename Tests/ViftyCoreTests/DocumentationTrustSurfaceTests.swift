...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("Legacy review results that predate `manualControlActive`, blocker-ID arrays, manual-smoke readiness provenance, agent-run readiness provenance, or agent-run startup-mode diagnostics are indexed as blank/unknown rather than inferred."))
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(exampleReadme.contains("require `recommendedAgentAction`, `recommendedRecoveryAction`, `recoverySteps`, `safeToRequestCooling`, `daemonControlPathReady`, `manualControlActive`, `failedCheckIDs`, and `coolingBlockerIDs`"))

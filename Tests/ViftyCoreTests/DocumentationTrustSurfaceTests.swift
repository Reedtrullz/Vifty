...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testAgentInstructionsTrackCurrentHelperInstallAndTestCount() throws {
        ...
        XCTAssertTrue(agents.contains("`swift test` runs `ViftyCoreTests` (839 tests)."))
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("The matrix evidence cell intentionally shows source ref plus short SHA, reviewed date, manual/agent smoke status, and agent-run startup mode when reviewed smoke evidence includes it"))
        ...
        XCTAssertTrue(compatibility.contains("Legacy review results that predate `manualControlActive`, blocker-ID arrays, or agent-run startup-mode diagnostics are indexed as blank/unknown rather than inferred."))

...
final class DocumentationTrustSurfaceTests: XCTestCase {
    func testReadmePositionsViftyAroundDeveloperWorkloadCooling() throws {
        ...
        XCTAssertTrue(readme.contains("the explicit source-checkout `make repair-helper` option"))
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(integrations.contains("show `repairHelperRecoveryActions` from `viftyctl agent-rule --json` when available"))

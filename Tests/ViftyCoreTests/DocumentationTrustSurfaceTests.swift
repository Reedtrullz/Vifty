...
final class DocumentationTrustSurfaceTests: XCTestCase {
    func testReadmePositionsViftyAroundDeveloperWorkloadCooling() throws {
        ...
        XCTAssertTrue(readme.contains("If `manualControlActive` stays true after one restore, stop and switch Vifty/default startup mode to Auto before another cooling request."))
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("Legacy review results that predate `manualControlActive` are indexed as blank/unknown rather than inferred."))
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(agentWorkflows.contains("Do not loop `restore-auto`; if `manualControlActive` stays true after one restore, stop and ask the user to switch Vifty/default startup mode to Auto"))
        ...
        XCTAssertTrue(guide.contains("Do not loop `restore-auto`; if `manualControlActive` stays true after one restore, stop and ask the user to switch Vifty/default startup mode to Auto"))
        ...
        XCTAssertTrue(integrations.contains("Do not loop `restore-auto`; if `manualControlActive` stays true after one restore, stop and ask the user to switch Vifty/default startup mode to Auto"))
        ...
        XCTAssertTrue(exampleReadme.contains("Do not loop `restore-auto`; if `manualControlActive` stays true after one restore, stop and ask the user to switch Vifty/default startup mode to Auto"))

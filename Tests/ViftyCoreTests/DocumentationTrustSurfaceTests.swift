...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("one current read-only report is rejected while manual control is active"))
        ...
        XCTAssertTrue(matrix.contains("| MacBookPro18 | Needs manual smoke | 0 | 4 | 1 | 0 | 1 |"))
        XCTAssertTrue(matrix.contains("source: main@24154ae, main@30035f8, main@8cbabb9, main@aec12c6, main@b757c4b<br>reviewed: 2026-06-15, 2026-06-16, 2026-06-17, 2026-06-18<br>manual: not recorded<br>agent-run: 2026-06-18-macbookpro18-main-agent-run-smoke/agent-run-smoke-evidence-summary.json"))
        XCTAssertTrue(index.contains("\"validatedHardwareReports\": 0"))
        XCTAssertTrue(index.contains("\"failedReports\": 1"))
        XCTAssertTrue(index.contains("\"manualSmokeRequiredReports\": 4"))
        XCTAssertTrue(index.contains("\"agentRunSmokePassedReports\": 1"))
        XCTAssertTrue(index.contains("\"rejected\": 1"))
        XCTAssertTrue(index.contains("\"countsByManualControlActive\": {"))
        XCTAssertTrue(index.contains("\"true\": 1"))

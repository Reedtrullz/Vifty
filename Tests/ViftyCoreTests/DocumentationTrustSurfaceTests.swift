...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("Three read-only local ad-hoc `MacBookPro18,1` candidate reports exist"))
        XCTAssertTrue(compatibility.contains("manualSmokeTestResult: \"not-recorded\""))
        XCTAssertTrue(matrix.contains("| MacBookPro18 | Needs manual smoke | 0 | 3 |"))
        XCTAssertTrue(matrix.contains("source: main@24154ae, main@8cbabb9, main@b757c4b<br>reviewed: 2026-06-15, 2026-06-16, 2026-06-17<br>manual: not recorded"))
        XCTAssertTrue(index.contains("\"validatedHardwareReports\": 0"))
        XCTAssertTrue(index.contains("\"manualSmokeRequiredReports\": 3"))

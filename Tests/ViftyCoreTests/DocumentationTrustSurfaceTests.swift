...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(integrations.contains("`schemaIDs.commandError`, `schemaIDs.run`, `wrapperResources`,"))
        ...
        XCTAssertTrue(integrations.contains("trusting the diagnose result for a cooling request. Use"))
        XCTAssertTrue(integrations.contains("`wrapperResources.bundleDirectory`, `wrapperResources.sourceDirectory`,"))
        XCTAssertTrue(integrations.contains("`wrapperResources.guardedRunScript`, and `wrapperResources.workloadScripts` to"))
        XCTAssertTrue(integrations.contains("choose the installed or source wrapper instead of inventing unaudited"))
        XCTAssertTrue(integrations.contains("fan-control commands."))

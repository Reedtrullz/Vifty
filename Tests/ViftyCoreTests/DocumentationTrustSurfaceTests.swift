...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(guide.contains("the exact JSON between those markers instead of parsing surrounding prose"))
        ...
        XCTAssertTrue(integrations.contains("do not parse surrounding human recovery"))
        ...
        XCTAssertTrue(exampleReadme.contains("Extract the exact JSON between those"))

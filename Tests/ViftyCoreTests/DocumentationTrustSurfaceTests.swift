...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testAgentInstructionsTrackCurrentHelperInstallAndTestCount() throws {
        ...
        XCTAssertTrue(agents.contains("`swift test` runs `ViftyCoreTests` (743 tests)."))
    ...
    func testReleaseAndHardwareDocsPointBackToCompatibilityStatus() throws {
        ...
        XCTAssertTrue(hardwareValidation.contains("not read-only when readiness is safe"))
        ...
        XCTAssertTrue(hardwareValidation.contains("run proof fields `coolingLeasePrepared`, `autoRestoreAttempted`,"))

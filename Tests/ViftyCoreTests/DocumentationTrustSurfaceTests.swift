...
final class DocumentationTrustSurfaceTests: XCTestCase {
    func testReadmePositionsViftyAroundDeveloperWorkloadCooling() throws {
        ...
        XCTAssertTrue(readme.contains("child command basename, command kind, argument count, and `childArgumentsPrivacy=omitted`"))
    ...
    func testReleaseAndHardwareDocsPointBackToCompatibilityStatus() throws {
        ...
        XCTAssertTrue(hardwareValidation.contains("records only the child command basename and argument count"))

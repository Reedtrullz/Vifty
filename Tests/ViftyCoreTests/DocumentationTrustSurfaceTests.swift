...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("schema version `1`, the stable capabilities schema ID, the safe `runLifecycle` contract"))
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(integrations.contains("schema version `1` and the stable capabilities schema ID"))
        ...
        XCTAssertTrue(exampleReadme.contains("require schema version `1`, the stable capabilities schema ID"))
        ...
        XCTAssertTrue(exampleReadme.contains("capabilities schema ID, `runLifecycle`"))

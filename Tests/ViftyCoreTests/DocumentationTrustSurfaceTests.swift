...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testSupportTriageGuideCoversEvidenceBuckets() throws {
        ...
        XCTAssertTrue(support.contains("write SMC keys"))
        ...
        XCTAssertTrue(agentCoolingTemplate.contains("It does not request cooling, restore Auto, call `ViftyHelper`, or write SMC keys."))
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(guide.contains("Check `privacy-review.tsv` before posting the bundle publicly"))
    ...
    func testStrategyWorkplanReflectsCurrentSourceFirstState() throws {
        ...
        XCTAssertTrue(workplan.contains("without requesting cooling, restoring Auto, calling `ViftyHelper`, or writing SMC keys"))

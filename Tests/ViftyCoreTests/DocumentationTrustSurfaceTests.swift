...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testHardwareValidationPreservesSourceFirstInstallProvenance() throws {
        ...
        XCTAssertTrue(hardwareValidation.contains("--source-sha a82f2237ff39c24a6b366dca8f95a17ee54fd972"))
        XCTAssertTrue(hardwareValidation.contains("--source-artifact ./Vifty-v1.1.1-unsigned-dev.zip"))

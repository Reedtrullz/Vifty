...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("Legacy review results that predate `manualControlActive` or agent-run startup-mode diagnostics are indexed as blank/unknown rather than inferred."))

...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testReleaseAndHardwareDocsPointBackToCompatibilityStatus() throws {
        ...
        XCTAssertTrue(hardwareValidation.contains("`run` command, `test` workload, and safe `runLifecycle` contract"))
        XCTAssertTrue(hardwareValidation.contains("contract, or when"))
        XCTAssertTrue(hardwareValidation.contains("readiness is blocked"))

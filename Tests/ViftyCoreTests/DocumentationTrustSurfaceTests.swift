...
final class DocumentationTrustSurfaceTests: XCTestCase {
    func testReadmePositionsViftyAroundDeveloperWorkloadCooling() throws {
        ...
        XCTAssertTrue(readme.contains("The guarded wrapper still refuses helper-repair, restore-first, backoff, and daemon-control-unavailable states."))
    ...
    func testAgentInstructionsTrackCurrentHelperInstallAndTestCount() throws {
        ...
        XCTAssertTrue(agents.contains("`swift test` runs `ViftyCoreTests` (742 tests)."))
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(integrations.contains("the wrapper still refuses helper-repair, restore-first, backoff, and daemon-control-unavailable states"))
        ...
        XCTAssertTrue(exampleReadme.contains("`restoreAutoBeforeRetry`, or when `daemonControlPathReady` is false"))

...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testReleaseStatusKeepsHomebrewInstallClaimsHonest() throws {
        ...
        XCTAssertTrue(readme.contains("The latest published public release is Vifty `v1.1.0`, a source-first release because the project does not currently have Apple Developer Program credentials."))
        ...
        XCTAssertTrue(readme.contains("The current source tree is prepared as Vifty `v1.1.1`, a source-first hotfix candidate"))
        ...
        XCTAssertTrue(releaseStatus.contains("the latest published public release is `v1.1.0`, a source-first release because the project does not currently have Apple Developer Program credentials."))
        ...
        XCTAssertTrue(releaseStatus.contains("The current source tree is prepared as `v1.1.1`, a source-first hotfix candidate"))
        ...
        XCTAssertTrue(releaseStatus.contains("`v1.1.1` should become the recommended source tag after its hotfix release is published."))
        ...
        XCTAssertTrue(releaseStatus.contains("## Source-First v1.1.1 Hotfix Candidate Checks"))
        XCTAssertTrue(releaseStatus.contains("scripts/check-release-readiness.sh --mode source-first --version 1.1.1"))
        XCTAssertTrue(releaseStatus.contains("RELEASE_VERSION=1.1.1 UNSIGNED_DEV_SOURCE_REF=HEAD make source-first-release-notes unsigned-dev-artifact"))
        ...
        XCTAssertTrue(hotfixNotes.contains("This is a source-first release. Vifty v1.1.1 does not include a Developer ID signed or notarized public binary"))
        XCTAssertTrue(hotfixNotes.contains("supersede the flawed `v1.1.0` unsigned-dev tester build"))

...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testSupportTriageGuideCoversEvidenceBuckets() throws {
        ...
        XCTAssertTrue(triage.contains("The readiness summary omits the full reason text, keeps `reasonCharacterCount`, and labels daemon path display privacy"))
    ...
    func testReleaseAndHardwareDocsPointBackToCompatibilityStatus() throws {
        ...
        XCTAssertTrue(hardwareValidation.contains("omits the full reason text, records `reasonCharacterCount`, and marks daemon path display values"))

...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("safe `runLifecycle` contract plus policy/metadata limits"))
    ...
    func testReleaseAndHardwareDocsPointBackToCompatibilityStatus() throws {
        ...
        XCTAssertTrue(hardwareValidation.contains("does not advertise the"))
        ...
        XCTAssertTrue(hardwareValidation.contains("safe `runLifecycle` contract and policy/metadata limits"))

...
final class DocumentationTrustSurfaceTests: XCTestCase {
    ...
    func testCompatibilityPageRequiresReportBackedEvidence() throws {
        ...
        XCTAssertTrue(compatibility.contains("schema version `1`, the stable capabilities, diagnose, and command-error schema IDs, wrapper resource discovery, the safe `runLifecycle` contract"))
    ...
    func testAgentIntegrationDocsPreferGuardedRunAndForbidRawWrites() throws {
        ...
        XCTAssertTrue(guide.contains("stable capabilities, diagnose, and command-error schema IDs"))
        ...
        XCTAssertTrue(agentWorkflows.contains("stable capabilities, diagnose, and command-error schema IDs"))
        ...
        XCTAssertTrue(integrations.contains("schema version `1` and the stable capabilities, diagnose, and command-error schema IDs"))
        ...
        XCTAssertTrue(exampleReadme.contains("require schema version `1`, the stable capabilities, diagnose, and command-error schema IDs"))
        ...
        XCTAssertTrue(exampleReadme.contains("capabilities, diagnose, and command-error schema IDs, `runLifecycle`"))

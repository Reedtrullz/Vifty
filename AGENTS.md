...
- `swift test` runs `ViftyCoreTests` (393 tests).
...
- `ViftyCtlProcessRunnerTests` tests child executable resolution, non-executable/missing command rejection before run, and shell-style exit-code mapping for real child signal exits.

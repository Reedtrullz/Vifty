...
- `examples/viftyctl/` — guarded-run shell wrapper and tested convenience wrappers for Swift, Xcode, Make, npm, pnpm, Bun, Go, cargo, pytest, local-model, and custom workloads.
...
- `swift test` runs `ViftyCoreTests` (862 tests).

...
- `swift test` runs `ViftyCoreTests` (580 tests).
...
- `DocumentationTrustSurfaceTests` keeps README/AGENTS/release/security/hardware-validation/agent/support docs linked to the evidence-backed compatibility status, trust model, support triage guide, helper-install trust surface, and safe agent-cooling runbook.

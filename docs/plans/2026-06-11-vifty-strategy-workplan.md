...
**Status:** Historical strategy record, superseded on 2026-09-13 by [the post-v1.4.8 validation workplan](2026-09-13-post-v1.4.8-validation.md). Its release and source-first claims preserve the planning context from June 2026; use [docs/release-status.md](../release-status.md) for current release facts.

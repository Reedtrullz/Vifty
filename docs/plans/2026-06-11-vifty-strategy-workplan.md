...
- `viftyctl` rejects unknown wrapper options, duplicate wrapper options, and unexpected positional arguments so agent typos fail closed instead of silently changing the intended command.

...
- CI and Release workflows now opt GitHub JavaScript actions into Node.js 24, and release metadata validation rejects either workflow if that runtime opt-in is removed.

...
- No `v1.1.0` GitHub Release artifact should be treated as published or trusted until the workflow publishes `Vifty-v1.1.0.zip`, `Vifty-v1.1.0.zip.sha256`, and `Vifty-v1.1.0-artifact-summary.json`.

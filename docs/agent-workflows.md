...
- requires `policyStatusAvailable: true` plus advertised policy duration/RPM limits and rejects durations or RPM percentages outside the daemon's advertised policy range before readiness or cooling,

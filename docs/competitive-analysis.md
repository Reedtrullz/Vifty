...
7. **Developer and agent workflow:** make Swift, Xcode, npm, Go, cargo, pytest, local-model, and custom guarded-run examples easy to find; defer MCP and Shortcuts until real users prove the CLI contract.
